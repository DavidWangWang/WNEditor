...
let kColumnScreenW = UIScreen.mainScreen().bounds.size.width
let kColumnScreenH = UIScreen.mainScreen().bounds.size.height
...
let kColumnItemBorderColor = UIColor.redColor().CGColor                        // item的色环
let kColumnItemColor = UIColor.redColor()                                      // item的文字颜色

let kColumnTitleMargin:CGFloat = 8                                      // title按钮之间默认没有间距，这个值保证两个按钮的间距
let kColumnTitleNorColor = UIColor.darkTextColor()                           // title普通状态颜色
let kColumnTitleSelColor = UIColor.redColor()                                  // title选中状态颜色
...
let kColumnIndicatorColor = UIColor.redColor()                                 // 默认使用系统风格颜色
...
let ZYScreenWidth  = UIScreen.mainScreen().bounds.width
let ZYScreenHeight = UIScreen.mainScreen().bounds.height
